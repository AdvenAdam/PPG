        ...
        for ($i = 0; $i < 50; $i++) {
            ...
            DB::table('generus')->insert([
                [
                    ...
                    'id_kelas' => $kelas,
                    'pendidikan_terakhir' => $faker->randomElement(['TK', 'SD', 'SMP', 'SMA', 'D3', 'S1', 'S2', 'S3']),
                    'status_pekerjaan' => $faker->randomElement(['BELUM SEKOLAH', 'PELAJAR', 'MAHASISWA', 'BEKERJA', 'BELUM BEKERJA', 'MONDOK']),
                    'detail_pekerjaan' => '',
